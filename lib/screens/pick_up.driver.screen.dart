...
class PickUpDriverScreen extends StatefulWidget {
  final String rideId;

  const PickUpDriverScreen({super.key, required this.rideId});

  @override
  _PickUpDriverScreenState createState() => _PickUpDriverScreenState();
}

class _PickUpDriverScreenState extends State<PickUpDriverScreen> {
  ...
  void initState() {
    ...
    socketService.pong((data) {
      ...
      Map<String, String> distanceInfo = LocationService.getDistance(
        ...
        double.parse(data!['riderLatitude']!),
        double.parse(data!['riderLongitude']!),
      );
      setState(() {
        _rideDetails = data!;
        ...
        _markerLocations = {
          ...
          'Pick Up Location':
              '${data!['pickLatitude']!},${data!['pickLongitude']!}',
        };
        _polyline = data!['polylineDriverToPick'] ?? '';
        // _polylinePoints =
        //     '${data!['pickLatitude']!},${data!['pickLongitude']!},${data!['dropLatitude']!},${data!['dropLongitude']!}';
      });
    });
  }
            ...
            appBar: AppBar(
              ...
              title: AnimatedTextKit(
                ...
                animatedTexts: [
                  ...
                  FadeAnimatedText(
                    'Pickup is $_distance $_distanceUnit away',
                    duration: Duration(seconds: 4),
                    fadeOutBegin: 0.9,
                    fadeInEnd: 0.1,
                    textStyle: TextStyle(
                            ...
                            child: SizedBox(
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  SoundService.playClickSound();
                                  _openMap(
                                    _rideDetails!['riderLatitude'],
                                    _rideDetails!['riderLongitude'],
                                    context,
                                  );
                                },
                                child: Row(
