...
class PickUpRiderScreen extends StatefulWidget {
  final String rideId;

  const PickUpRiderScreen({super.key, required this.rideId});

  @override
  _PickUpRiderScreenState createState() => _PickUpRiderScreenState();
}

class _PickUpRiderScreenState extends State<PickUpRiderScreen> {
  ...
  void initState() {
    ...
    socketService.pong((data) {
      ...
      Map<String, String> distanceInfo = LocationService.getDistance(
        ...
        double.parse(data!['driverLatitude']!),
        double.parse(data!['driverLongitude']!),
      );
      // print(data!['polyline']);
      setState(() {
        _rideDetails = data!;
        ...
        // _polyline = data!['polylineRiderToPick'] ?? '';
            ...
            appBar: AppBar(
              ...
              title: AnimatedTextKit(
                ...
                animatedTexts: [
                  ...
                  FadeAnimatedText(
                    'Driver is $_distance $_distanceUnit away',
                    duration: Duration(seconds: 4),
                    fadeOutBegin: 0.9,
                    fadeInEnd: 0.1,
                    textStyle: TextStyle(
